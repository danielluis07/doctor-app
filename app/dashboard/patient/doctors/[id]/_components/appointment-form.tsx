...
import {
  ...
  DialogTrigger,
  DialogClose,
} from "@/components/ui/appointment-dialog";
...
export const AppointmentForm = ({
  ...
  return (
    <Dialog open={isOpen}>
      <DialogTrigger
        onClick={onOpen}
        className="flex items-center px-3 py-2 bg-gradient-to-r from-sky-500 to-blue-600 text-primary-foreground shadow hover:bg-sky-300 rounded-lg focus:outline-none">
        Solicitar consulta
      </DialogTrigger>
